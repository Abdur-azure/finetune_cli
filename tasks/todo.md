...
- [x] xlmtec/tui/app.py — xlmtecApp(App), SCREENS dict, keybindings (q=quit, h/esc=home), on_mount → HomeScreen
...
- [x] cli/main.py — add `tui` subcommand (import xlmtecApp inside function, call App().run())
