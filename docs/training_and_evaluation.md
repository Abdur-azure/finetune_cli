...
**Example:**
```python
from xlmtec.trainers import train_with_lora
...
**Example:**
```python
from xlmtec.trainers import train_with_qlora
...
**Best Practices:**
```python
from xlmtec.trainers import get_qlora_best_practices
...
**Memory Estimation:**
```python
from xlmtec.trainers import FullFineTuner
...
**Example:**
```python
from xlmtec.trainers import train_full_finetuning
...
from xlmtec.trainers import train_model
...
```python
from xlmtec.evaluation.metrics import ExactMatchMetric
...
```python
from xlmtec.evaluation import benchmark_models
...
```python
from xlmtec.evaluation import ReportGenerator
from pathlib import Path
...
```python
from xlmtec.evaluation import compare_metrics
...
```python
from xlmtec.core.config import ConfigBuilder
from xlmtec.core.types import TrainingMethod, EvaluationMetric
from xlmtec.models.loader import load_model_and_tokenizer
from xlmtec.data import prepare_dataset
from xlmtec.trainers import train_model
from xlmtec.evaluation import evaluate_model
...
```python
from xlmtec.trainers import MethodRecommender
